			  ...
			  <div class="panel-body">
				<form role="form">
				  <div class="form-group">
					...
					<input type="text" class="form-control" autofocus="autofocus" id="gcname" placeholder="请输入商品分类名称">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">简介</label>
					<input type="text" class="form-control" id="gcremark" placeholder="请输入商品分类简介">
				  </div>
				  <div class="form-group">
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#insertBtn").click(function(){
			    	...
			    	$.ajax({
			    		type : "POST",
			    		url  : "${APP_PATH}/goodsCategory/insert",
			    		data : {
			    			"name" : gcname,
			    			"remark" : gcremark,
			    		...
			    		success : function(result) { // 浏览器请求状态：200, 302, 404, 403,500, 503
			    			...
			    			if ( result.success ) { // 业务成功或者失败
			    	    		layer.msg("商品分类信息保存成功", {time:2000, icon:6}, function(){
			    	    			window.location.href = "${APP_PATH}/goodsCategory/index";
			    	    		});
			    			} else {
			    	    		layer.msg("商品分类信息保存失败，请重新输入", {time:2000, icon:5, shift:6}, function(){
			    	    		});
			    			}
			    		}
			    	});
