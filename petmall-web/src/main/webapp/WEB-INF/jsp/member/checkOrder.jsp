      ...
      <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse" style="float:right;">
              <ul class="nav navbar-nav">
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-user"></i>  ${loginUser.loginacct}<span class="caret"></span></a>
                        ...
                        <div class="container-fluid">
                            <div class="row clearfix">
                                <div class="col-md-12 column">
                                    <blockquote style="border-left: 5px solid #f60;color:#f60;padding: 0 0 0 20px;">
                                        <b>
                                            商品信息 <a style="font-size:12px;" href="pay-step-1.html">修改数量</a>
                                        </b>
                                    </blockquote>
                                </div>
                                <div class="col-md-12 column">
                                ...
                                <div class="col-md-12 column">
                                        <div class="alert alert-warning alert-dismissable" style="text-align:right; border:2px solid #ffc287;">
                                            <ul style="list-style:none;" >
                                                ...
                                                <li style="margin-top:10px;">
                                                <button type="button" class="btn btn-warning btn-lg" onclick="doOrder()"><i class="glyphicon glyphicon-credit-card"></i> 先下单，稍后付款</button>
                                                <button disabled="disabled" type="button" class="btn btn-warning btn-lg" onclick="window.location.href='javascript:;"><i class="glyphicon glyphicon-credit-card"></i> 立即付款</button>
                                                </li>
                                                <li style="margin-top:10px;">
                                                  <div class="checkbox">
                                                    <label>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-md-12 column">
                                            <blockquote>
                                                ...
                                                <span style="font-size:12px;">1.请在下单后15分钟内付款，否则您的订单会被自动关闭</span>
                                            </blockquote>
                                        </div>
                                    </div>
                                </div>
...
$(":radio[name='optionsRadios11']").click(function(){
    ...
    function doOrder() {
    	window.location.href = "${APP_PATH}/member/doOrder";
    }
