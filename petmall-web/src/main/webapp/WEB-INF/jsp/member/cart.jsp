                                    ...
                                    <div class="col-md-3 column">
                                        <div class="progress" style="height:50px;border-radius:0;    position: absolute;width: 75%;right:49px;">
                                          <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 100%;height:50px;">
                                            <div style="font-size:16px;margin-top:15px;">1. 确认购物车商品</div>
                                          </div>
                                        </div>
                        ...
                        <div class="container-fluid">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-12 column">
                                    ...
                                    <p>总价(含运费)：<span style="font-size:16px;color:#F60;" id="totalpriceSpan">￥1.00</span></p>
                                    <button type="button" class="btn btn-warning btn-lg" style="float:right;" onclick="window.location.href='${APP_PATH}/member/checkOrder'"><i class="glyphicon glyphicon-credit-card"></i> 我要下单</button>
                                    </div>
                                </div>
                                ...
                                <span style="font-size:12px;">1.为了避免商品购买后，因样式，材料等原因所产生的纠纷，请在下单前确认购买的商品明细。</span>
                                            </blockquote>
                                        </div>
                                    </div>
                                </div>
    	 ...
    	 $.ajax({
    		 ...
    		 success : function(result) {
    			 ...
    			 $.each(carts, function(i, cart){
                     content += '<tr>';
	                 content += '    <td>'+cart.goodsname+'</td>';
	                 content += '    <td>'+cart.introduce+'</td>';
	                 content += '    <td>'+cart.goodsremark+'</td>';
	                 content += '    <td><input type="text" class="form-control" style="width:60px;" value="'+cart.num+'"></td>';
	                 content += '    <td style="color:#F60">￥ '+cart.price+'</td>';
	                 content += '    <td>免运费</td>';
	                 content += '  </tr>';
